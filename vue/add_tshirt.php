    ...
    <main class="page contact-us-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form>
                    <div class="form-group"><label for="name">Modèle</label><input class="form-control" type="text" id="name" name="modele"></div>
                    <div class="form-group"><label for="subject">Marque</label><input class="form-control" type="text" id="subject" name="marque"></div>
                    <div class="form-group"><label for="email">Prix</label><input class="form-control" type="number" name="prix"></div>
                    <div class="form-group"><label for="message">Description</label><textarea class="form-control" id="message" name="description"></textarea></div>
