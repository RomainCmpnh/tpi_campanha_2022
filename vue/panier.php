                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="summary">
                                ...
                                <div class="form-group" style="margin-top: 1%;"><label for="email">Email :&nbsp;</label><input type="email" id="email" class="item" name="email"></div><button class="btn btn-primary btn-block btn-lg" type="button" style="background: rgb(0,0,0);border-color: rgb(0,0,0);">Commander</button>
                            </div>
                        </div>
                    </div>
                </div>
