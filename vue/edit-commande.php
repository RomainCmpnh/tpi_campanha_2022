        ...
        <section class="clean-block clean-cart dark">
            <div class="container">
                <div class="block-heading">
                    <p style="font-family: 'Roboto Slab', serif;font-size: 36px;color: rgb(0,0,0);text-align: center;margin-bottom: 11px;">Editer le panier</p>
                    <p>Les articles suivant seront enregistrés</p>
                </div>
                <div class="content">
                    <div class="row no-gutters">
                            ...
                            <div class="items">
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-5 product-info"><a class="product-name" href="#" style="border-color: rgb(0,0,0);color: rgb(0,0,0);">Tshirt noir</a>
                                            <div class="product-specs">
                                                <div><span>Marque:&nbsp;</span><span class="value">5 inch</span></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-2 quantity"><label class="d-none d-md-block" for="quantity">Quantité</label><input type="number" id="number" class="form-control quantity-input" value="1"></div>
                                        <div class="col-6 col-md-2 price"><span>30 CHF</span></div>
                                        <div class="col-6 col-md-2 price"><i class="fa fa-trash" style="color: var(--red);"></i></div>
                                    </div>
                                </div>
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                ...
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        <div class="col-6 col-md-2 quantity"><label class="d-none d-md-block" for="quantity">Quantité</label><input type="number" id="number-1" class="form-control quantity-input" value="1"></div>
                                        <div class="col-6 col-md-2 price"><span>30 CHF</span></div>
                                        <div class="col-6 col-md-2 price"><i class="fa fa-trash" style="color: var(--red);"></i></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="summary">
                                <h3>Aperçu</h3>
                                <h4><span class="text">Montant de la commande</span><span class="price">30 CHF</span></h4>
                                <h4><span class="text">Total</span><span class="price">30 CHF</span></h4><button class="btn btn-primary btn-block btn-lg" type="button" style="background: rgb(0,0,0);border-color: rgb(0,0,0);">Sauvegarder</button>
                            </div>
                        </div>
                    </div>
                </div>
